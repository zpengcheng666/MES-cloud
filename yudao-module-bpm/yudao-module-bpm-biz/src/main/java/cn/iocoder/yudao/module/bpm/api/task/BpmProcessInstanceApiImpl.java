...
public class BpmProcessInstanceApiImpl implements BpmProcessInstanceApi {
    ...
    @Override
    public void cancelProcessInstanceByStartUser(Long userId, @Valid BpmProcessInstanceCancelReqDto dto) {
        processInstanceService.cancelProcessInstanceByStartUser(userId,dto);
    }
