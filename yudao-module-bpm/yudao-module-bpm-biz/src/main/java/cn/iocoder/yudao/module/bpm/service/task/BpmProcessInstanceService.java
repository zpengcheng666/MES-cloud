...
public interface BpmProcessInstanceService {
    ...
    void cancelProcessInstanceByStartUser(Long userId, @Valid BpmProcessInstanceCancelReqDto dto);
    /**
     * 管理员取消流程实例
     *
     * @param userId           用户编号
    ...
    /**
     * 获取用户的历史流程实例出现次数最多的key
     * @param userId
     * @return
     */
    List<String> getProcessInstanceKeyList(Long userId);
