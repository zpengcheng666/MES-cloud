...
public class BpmProcessDefinitionServiceImpl implements BpmProcessDefinitionService {
    ...
    @Override
    public List<ProcessDefinition> getCommonUseProcessDefinitionList(List<String> keyList) {
        // 拼接查询条件
        ProcessDefinitionQuery query = repositoryService.createProcessDefinitionQuery();
        query.active();
        query.processDefinitionTenantId(FlowableUtils.getTenantId());
        List<ProcessDefinition> list = query.list();
        //List<String> processInstanceKeyList = processInstanceService.getProcessInstanceKeyList(getLoginUserId());
