...
public interface BpmProcessInstanceApi {
    ...
    @PostMapping(PREFIX + "/cancelProcessInstanceByStartUser")
    @Operation(summary = "发起人取消流程实例")
    @Parameter(name = "userId", description = "用户编号", required = true, example = "1")
    void cancelProcessInstanceByStartUser(@RequestParam("userId")Long userId, @Valid @RequestBody BpmProcessInstanceCancelReqDto cancelReqVO);
