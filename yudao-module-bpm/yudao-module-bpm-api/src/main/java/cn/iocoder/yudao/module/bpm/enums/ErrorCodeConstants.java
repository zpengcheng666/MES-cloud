...
public interface ErrorCodeConstants {
    ...
    // ========== BPM 业务表单 1-009-015-000 ==========
    ErrorCode OA_PURCHASE_NOT_EXISTS = new ErrorCode(1_009_015_000, "OA 采购申请不存在");
    ErrorCode OA_SUPPLY_NOT_EXISTS = new ErrorCode(1_009_015_001, "OA 物品领用不存在");
    ErrorCode OA_MEETING_NOT_EXISTS = new ErrorCode(1_009_015_002, "OA 会议申请不存在");
    ErrorCode OA_CLOCK_NOT_EXISTS = new ErrorCode(1_009_015_003, "OA 打卡不存在");
    ErrorCode OA_CLOCK_IN_EXISTS = new ErrorCode(1_009_015_004, "已打过上班卡");

    ErrorCode PARAM_NOT_NULL = new ErrorCode(1_009_016_001, "必填参数不能为空");
