...
@Schema(description = "管理后台 - 订单物料关系表 Response VO")
@Data
@ExcelIgnoreUnannotated
public class OrderMaterialRelationRespVO {
    ...
    @ExcelProperty("项目id(本地关联时写入)")
    private String orderId;

    @Schema(description = "物料编码，牌号，毛坯(本地关联时写入)")
    @ExcelProperty("物料编码，牌号，毛坯(本地关联时写入)")
    ...
    @ExcelProperty("变码，工序加工后，产生的新码")
    private String variableCode;

    @Schema(description = "图号(成品工件)")
    @ExcelProperty("图号(成品工件)")
