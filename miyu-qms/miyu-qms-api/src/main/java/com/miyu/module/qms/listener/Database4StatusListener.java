...
/**
 * 质量控制管理资料库审批的结果的监听器实现类
 *
 * @author Zhangyunfei
 */
@Component
public class Database4StatusListener extends BpmProcessInstanceStatusEventListener {
    ...
    public String getProcessDefinitionKey() {
        return ApiConstants.DATABASE4_AUDIT_PROCESS_KEY;
    }
