...
/**
 * 质量管理体系管理资料库审批的结果的监听器实现类
 *
 * @author Zhangyunfei
 */
@Component
public class Database1StatusListener extends BpmProcessInstanceStatusEventListener {
    ...
    public String getProcessDefinitionKey() {
        return ApiConstants.DATABASE1_AUDIT_PROCESS_KEY;
    }
