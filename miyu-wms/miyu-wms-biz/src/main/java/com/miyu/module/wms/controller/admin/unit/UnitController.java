package com.miyu.module.wms.controller.admin.unit;
...
import com.miyu.module.wms.service.unit.UnitService;
...
public class UnitController {
    ...
    @PreAuthorize("@ss.hasPermission('wms:unit:create')")
    ...
    @PreAuthorize("@ss.hasPermission('wms:unit:update')")
    ...
    @PreAuthorize("@ss.hasPermission('wms:unit:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('wms:unit:query')")
    ...
    @PreAuthorize("@ss.hasPermission('wms:unit:export')")
