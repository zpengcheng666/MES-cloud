...
public class AdminUserApiImpl implements AdminUserApi {
    ...
    @Override
    public CommonResult<Long> createUser(UserSaveReqVOTemp req) {
        UserSaveReqVO reqVO = BeanUtils.toBean(req, UserSaveReqVO.class);
        Long id = userService.createUser(reqVO);
        return success(id);
    }

    @Override
    public CommonResult<AdminUserRespDTO> getByUsername(String username) {
