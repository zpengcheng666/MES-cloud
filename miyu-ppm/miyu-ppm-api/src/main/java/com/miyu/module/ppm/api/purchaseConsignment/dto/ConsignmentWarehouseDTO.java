...
@Schema(description = "管理后台 - 采购收货单一物一码 Request VO")
@Data
public class ConsignmentWarehouseDTO {
    ...
    @Schema(description = "收货明细 一物一码列表")
    private List<WarehouseRespDTO> purchaseConsignmentDetails;
