...
@Component
@Slf4j
public class ContractContactParseFunction implements IParseFunction {

    public static final String NAME = "getContractContact";
    @Resource
    ...
    public String apply(Object value) {
        ...
        return companyContactService.getCompanyContact((String) value).getName();
    }
