...
@Service
@Transactional
public class ContratcConsignmentCreate implements IShippingFactory {
    ...
    public void validateCreate(ShippingSaveReqVO reqVO) {
        ...
        //根据项目查询已经发货的发货单
        List<ShippingDetailDO> shippingDetailDOS =  shippingService.getShippingDetailListByProjectId(null,reqVO.getContractId(),reqVO.getShippingType());
