...
public class ShippingReturnDetailPageReqVO extends PageParam {

    @Schema(description = "退货单ID", example = "17113")
    private String shippingReturnId;

    @Schema(description = "合同订单ID", example = "16163")
    ...
    @Schema(description = "物料库存ID", example = "6074")
