...
public class ServiceExceptionUtil {
    ...
    public static ServiceException exception(ErrorCode errorCode) {
        ...
        log.error("[ServiceException][错误码({})|错误内容({})]", errorCode.getCode(), messagePattern);
    ...
    public static ServiceException exception(Integer code, String msg) {
        String messagePattern = MESSAGES.getOrDefault(code, msg);
        log.error("[ServiceException][错误码({})|错误内容({})]", code, messagePattern);
